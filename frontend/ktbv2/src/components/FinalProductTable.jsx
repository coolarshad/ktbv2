      ...
      <table className="min-w-full bg-white">
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[160px] z-30 bg-gray-100 min-w-[350px] max-w-[350px] w-[350px] border-r border-gray-300">Formula Name</th>
          ...
          {data && data.length > 0 ? (
            data.map((item, index) => (
              <tr key={index}>
                ...
                <td className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[160px] z-10 bg-white min-w-[350px] max-w-[350px] w-[350px] border-r border-gray-300">{item?.formula_detail?.formula_name}</td>
            ...
            <tr>
              <td colSpan="15" className="py-4 text-center text-gray-500 font-medium">
                Match Not Found.
              </td>
            </tr>
          )}
