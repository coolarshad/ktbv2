      ...
      <table className="min-w-full bg-white">
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[50px] z-30 bg-gray-100 min-w-[120px] max-w-[120px] w-[120px]">Ref</th>
            <th className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[170px] z-30 bg-gray-100 min-w-[200px] max-w-[200px] w-[200px]">Name</th>
            <th className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[370px] z-30 bg-gray-100 min-w-[110px] max-w-[110px] w-[110px] border-r border-gray-300">Date</th>
          ...
          {data && data.length > 0 ? (
            data.map((item, index) => (
              <tr key={index}>
                ...
                <td className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[50px] z-10 bg-white min-w-[120px] max-w-[120px] w-[120px]">{item.ref}</td>
                <td className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[170px] z-10 bg-white min-w-[200px] max-w-[200px] w-[200px]">{item.name}</td>
                <td className="py-2 px-4 border-b border-gray-200 text-sm font-medium sticky left-[370px] z-10 bg-white min-w-[110px] max-w-[110px] w-[110px] border-r border-gray-300">{item.date}</td>
