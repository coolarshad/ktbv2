...
<button
        ...
        <div>
        <CostMgtFilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/costmgt/raw-materials/'} fieldOptions={fieldOptions} downloadUrl="/excel/export/raw-material/" fileName="Raw_Material_export" statusField="approved" />
        </div>
