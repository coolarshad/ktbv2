...
const SalesPending = () => {
    ...
    return (
        ...
        <div>
        <FilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/trademgt/trade-pending'} extraParams={{ trade_type: 'Sales' }} downloadUrl="/excel/export/trade-pending/?trade_type=Sales" fileName="Sales_Pending_export" fieldOptions={fieldOptions} />
        </div>
