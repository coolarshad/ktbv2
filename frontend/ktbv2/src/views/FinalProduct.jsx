    ...
    return (
        <>
            <div className="w-full h-full rounded bg-slate-200  p-3	">
                ...
                {hasPermission(user, 'create_final_product_cost') && (
<button
                ...
                <div>
                    ...
                    <CostMgtFilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/costmgt/final-product/'} fieldOptions={fieldOptions} downloadUrl="/excel/export/final-product/" fileName="Final_Product_export" statusField="approved" />

                </div>
                <div className=" rounded p-2">
                    <FinalProductTable data={currentItems} onDelete={handleDelete} onView={handleViewClick} basePerm="final_product_cost" />
        <Pagination itemsPerPage={50} totalItems={productData?.length || 0} paginate={paginate} currentPage={currentPage} />
                </div>
            </div>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr className="border-b border-gray-200">
                                            <td className="py-2 px-4 text-gray-600 font-medium capitalize">Total Oil Consumed</td>
                                            <td className="py-2 px-4 text-gray-800">{selectedProduct.total_oil_consumed}</td>
                                        </tr>
                  ...
                  />
                                ...
                                {selectedProduct.approved ? '' :
                                    <div className='grid grid-cols-3 gap-4 mt-4 mb-4'>
                                        {hasPermission(user, 'approve_final_product_cost') && (
<button onClick={approveFinalProduct} className="bg-blue-500 text-white p-2 rounded col-span-3">Approve</button>
                                ...
                                <div className="mt-4 p-4 border-t border-gray-200 bg-gray-50 rounded">
                                  ...
                                  {selectedProduct?.notified_users_emails?.length > 0 ? (
                                    <ul className="list-disc pl-5">
                                      {selectedProduct.notified_users_emails.map((email, idx) => (
