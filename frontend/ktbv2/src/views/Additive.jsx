...
<button
        ...
        <div>
        <CostMgtFilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/costmgt/additives/'} fieldOptions={fieldOptions} downloadUrl="/excel/export/additive/" fileName="Additive_export" statusField="approved" />
        </div>
