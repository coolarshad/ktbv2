...
useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    if (mode === "add") {
      axios
        .post("/costmgt/additive-categories/", payload)
        .then(() => navigate("/additive-categories"))
        .catch((error) => console.error("Error adding category:", error));
    } else {
      axios
        .put(`/costmgt/additive-categories/${id}/`, payload)
        .then(() => navigate("/additive-categories"))
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-full lg:w-2/3 mx-auto">
      <p className="text-xl text-center">Additive Category Form</p>
...
export default AdditivesCategoryForm;
