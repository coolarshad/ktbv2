...
const PurchaseProductTrace = () => {
    ...
    return (
        ...
        <div>
        <FilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/trademgt/product-trace'} extraParams={{ trade_type: 'Purchase' }} downloadUrl="/excel/export/product-trace/?trade_type=Purchase" fileName="Purchase_Product_Trace_export" fieldOptions={fieldOptions} />
        </div>
