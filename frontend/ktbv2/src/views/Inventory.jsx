...
const Inventory = () => {
  ...
  const [modalVisible, setModalVisible] = useState(false);
    ...
    return (
        ...
        <div>
        <FilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/trademgt/inventory'} fieldOptions={fieldOptions} downloadUrl="/excel/export/inventory/" fileName="Inventory_export" />
        </div>
