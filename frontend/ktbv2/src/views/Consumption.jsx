...
<button
        ...
        <div>
          <CostMgtFilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/costmgt/consumption/'} fieldOptions={fieldOptions} downloadUrl="/excel/export/consumption/" fileName="Consumption_export" statusField="approved" />
        </div>
