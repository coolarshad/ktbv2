...
const ConsumptionFormula = () => {
    ...
    return (
        ...
        {hasPermission(user, 'create_blending_formulation') && (
<button
        ...
        <div>
          <CostMgtFilterComponent checkBtn={false} flag={2} onFilter={handleFilter} apiEndpoint={'/costmgt/consumption-formula/'} fieldOptions={fieldOptions} downloadUrl="/excel/export/consumption-formula/" fileName="Blending_Formulation_export" statusField="approved" />
        </div>
             ...
             {!selectedConsumption.approved && (
              ...
              {selectedConsumption.approved ? '' :
                    <div className='grid grid-cols-3 gap-4 mt-4 mb-4'>
                      {hasPermission(user, 'approve_blending_formulation') && (
