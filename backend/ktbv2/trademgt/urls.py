...
router.register(r'product-trace', TradeProductTraceViewSet)
router.register(r'product-ref', TradeProductRefViewSet)
# router.register(r'sales-trace', SalesProductTraceViewSet)
router.register(r'trade-pending', TradePendingViewSet)
...
urlpatterns = [
    ...
    path('refproductcode/', RefProductCodeView.as_view(), name='refproductcode'),
]+ router.urls
