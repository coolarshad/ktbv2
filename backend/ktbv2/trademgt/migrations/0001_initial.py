    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance_within', models.IntegerField(verbose_name='advance_within')),
                ('payment_within', models.IntegerField(verbose_name='payment_within')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production_date', models.FloatField(verbose_name='production_date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('packing', models.CharField(max_length=25, verbose_name='packing')),
                ('cost_of_packing_per_each', models.FloatField(verbose_name='cost_of_packing_per_each')),
                ('total_packing_cost', models.FloatField(verbose_name='total_packing_cost')),
                ...
                ('bl_declaration', models.CharField(max_length=100, verbose_name='bl_declaration')),
                ...
                ('approved_by', models.CharField(max_length=50, verbose_name='approved_by')),
            ],
            options={
                'verbose_name': 'Trade',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance_payment', models.FloatField(verbose_name='balance_payment')),
                ('balance_payment_received', models.FloatField(verbose_name='balance_payment_received')),
                ('balance_paymnet_made', models.FloatField(verbose_name='balance_paymnet_made')),
                ('net_due_in_this_trade', models.FloatField(verbose_name='net_due_in_this_trade')),
                ...
                ('logistic_cost', models.FloatField(verbose_name='logistic_cost')),
                ('commission_agent_value', models.FloatField(verbose_name='commission_agent_value')),
                ('bl_fee', models.FloatField(verbose_name='bl_fee')),
                ('bl_collection_cost', models.FloatField(verbose_name='bl_collection_cost')),
                ('shipment_status', models.CharField(max_length=50, verbose_name='shipment_status')),
                ...
                ('trn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trademgt.trade', verbose_name='trn')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trademgt.trade', verbose_name='trade')),
            ],
            options={
