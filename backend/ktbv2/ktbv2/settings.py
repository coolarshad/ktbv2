"""
Django settings for ktbv2 project.
...
SECRET_KEY = 'django-insecure-p4z1l_whaktwugm_u$4ka*4pu4#+_nuhenbt0n)9$u02geisv0'
...
MIDDLEWARE = [
    ...
    'ktbv2.middleware.ActivityLogMiddleware',
]
...
WSGI_APPLICATION = 'ktbv2.wsgi.application'
